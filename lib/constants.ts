...
export const kazeNoYashiroApartments = [
  {
...
export const yamaNoSatoApartments = [
  {
...
export const newsAndEventInfoCards = [
  {
    src: "news1.jpg",
    date: "MAY 11, 2024",
    type: "EVENT",
...
export const posts: { [key: string]: PostProps } = {
  "1": {
    title: "Moonlit Onsen Soiree",
    paragraphs: [
