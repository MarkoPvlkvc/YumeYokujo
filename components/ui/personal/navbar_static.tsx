...
const NavbarStatic = () => {
  return (
    ...
    >
      ...
      <Link
        href="/book-now"
        className="-mr-[1px] hidden h-[100%] w-fit text-nowrap rounded-3xl bg-darkBlue px-8 text-sm font-medium text-white transition-colors hover:bg-[#376075] xl:block"
      >
